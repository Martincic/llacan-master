<template>
  <section>
      ...
      <div class="hover">
        ...
        <div class="hover__text pt-xxl">
          ...
          <p class="hover-text__adress fs-base pb-xs">
            <span class="icon-home-icon "></span>Prilaz Kikova 5, 52220, Labin
          </p>
      ...
      <div class="choice u-flex u-flex-fd--c">
        ...
        <div class="my-choice__orders u-flex-fd-c border-box">
          ...
          >
            ...
            <div
              class="my-choice-information__price pr-sm fs-base font-normal-medium"
            >
              <p>22,00 kn</p>
            </div>
          </div>
    ...
    <section class="modal" v-if="modalOpened">
      ...
      <div
        class="overlay__table  font-normaln-bold fs-md mlr-sm u-flex u-flex-fd--c"
      >
    ...
    <section class="modal-send border-box" v-if="modalSend">
      ...
      <div class="model-send__buttons u-flex u-flex-fd--r u-flex-jc--c">
        <div class="model-send-buttons__back">
          <button class="btn pr-md fc-base font-normal-sm-n">
